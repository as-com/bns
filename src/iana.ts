...
export function getPort(service: string) {
...
export function protocolToString(protocol: number) {
	return toSymbol(protocol, 'protocol', Protocol, 'PROTOCOL', 0xff, 3);
}

export function stringToProtocol(symbol: string) {
	return fromSymbol(symbol, 'protocol', Protocol, 'PROTOCOL', 0xff, 3);
}

export function isProtocolString(symbol: string) {
	return isSymbol(symbol, 'protocol', Protocol, 'PROTOCOL', 0xff, 3);
}
