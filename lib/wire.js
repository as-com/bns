...
function truncate(msg, max) {
  ...
  msg.writeUInt16BE(bits | flags.TC, 2, true);
...
export {algHashes}
export {nsecHashes}
export {nsecHashesByVal}
export {certTypes}
export {certTypesByVal}
export {usages}
export {usagesByVal}
export {selectors}
export {selectorsByVal}
export {matchingTypes}
export {matchingTypesByVal}
export {sshAlgs}
export {sshAlgsByVal}
export {sshHashes}
export {sshHashesByVal}
export {tsigAlgs}
export {tsigAlgsByVal}
export {tkeyModes}
export {tkeyModesByVal}
